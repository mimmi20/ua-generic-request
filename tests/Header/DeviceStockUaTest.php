...
class DeviceStockUaTest extends TestCase
{
    ...
    public function providerUa(): array
    {
        return [
            ...
            ['Mozilla/5.0 (Series40; Nokia501/11.1.1/java_runtime_version=Nokia_Asha_1_1_1; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/3.9.0.0.22', true, true, true],
            ['Mozilla/5.0 (Series40; Nokia501/11.1.1/java_runtime_version=Nokia_Asha_1_1_1; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/3.1.1.0.27', true, true, true],
            ['Mozilla/5.0 (Bada 2.0.0)', false, true, true],
            ...
            ['OperaMini(Fucus/Unknown;Opera Mini/4.4.31223;en)', false, true, true],
            ['OperaMini(Lava-Discover135;Opera Mini/4.4.31762;en)', true, true, true],
            ['OperaMini(Gionee_1305;Opera Mini/4.4.31989;en)', true, true, true],
            ...
            ['NativeOperaMini(Spreadtrum/Unknown;Native Opera Mini/4.4.29625;pt)', false, true, true],
            ['NativeOperaMini(Spreadtrum/HW Version:        SC6531_OPENPHONE;Native Opera Mini/4.4.31227;en)', true, true, true],
            ['PhilipsX2300/W1245_V12 ThreadX_OS/4.0 MOCOR/W12 Release/11.08.2012 Browser/Dorado1.0', true, true, true],
            ['ReksioVRE(196683)', false, true, true],
            ['Motorola', false, true, true],
