...
final class XOperaminiPhoneUaTest extends TestCase
{
    ...
    {
        return [
            ['BlackBerry8520/5.0.0.681 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/613', true, true, true],
            ['BlackBerry8900/5.0.0.1113 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/100', true, true, true],
            ['SAMSUNG-GT-i8000/1.0 (Windows CE; Opera Mobi; U; en) Opera 9.5 UNTRUSTED/1.0', true, true, true],
            ...
            ['HTC_Touch_Pro_T7272', true, false, false],
            ...
            ['BlackBerry8520/5.0.0.1036 Profile/MIDP-2.1 Configuration/CLDC-1.1 VendorID/613', true, true, true],
            ...
            ['Samsung SCH-U380', true, false, false],
            ['Pantech TXT8045', true, false, false],
            ['ZTE F-450', true, false, false],
            ['LG VN271', true, false, false],
            ['Casio C781', true, false, false],
            ['Samsung SCH-U485', true, false, false],
            ['Pantech CDM8992', true, false, false],
            ['LG VN530', true, false, false],
            ['Samsung SCH-U680', true, false, false],
            ['Pantech CDM8999', true, false, false],
