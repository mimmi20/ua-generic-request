...
final class XRequestedWith implements HeaderInterface
{
    ...
    public function getClientCode(): string | null
    {
        ...
        return match (mb_strtolower($this->value)) {
            ...
            'de.twokit.castbrowser', 'de.twokit.video.tv.cast.browser.samsung', 'de.twokit.video.tv.cast.browser.lg', 'de.twokit.video.tv.cast.browser.firetv', 'de.twokit.castbrowsernexusplayer' => 'tv-cast',
            ...
            'com.nate.android.portalmini' => 'nate-app',
            'com.bigqsys.photosearch.searchbyimage2020' => 'photo-search-app',
            ...
            'io.bluewallet.bluewallet' => 'blue-wallet',
            'com.bifrostwallet.app' => 'bifrost-wallet',
            'com.tt.android.dm.view' => 'download-manager',
            'com.wukongtv.wkcast.intl' => 'quick-cast-app',
            'mobi.deallauncher.coupons.shopping' => 'coupons-promo-codes',
            'idm.video.free' => 'idm-video-download-manager',
            'com.tuya.smartlife' => 'smart-life',
